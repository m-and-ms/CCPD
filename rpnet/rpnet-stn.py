...
wR2Path = './model/wR2-stn.pthstn-epoch-20'
...
if not resume_file == '111':#在原来的基础上继续训练模型
    ...
    model_conv = fh02(numPoints, numClasses,wR2Path)#wR2Path
    if use_gpu:
        ...
        model = torch.load(resume_file,map_location='cpu')
...
def train_model(model, criterion, optimizer, num_epochs=25):
    ...
    # print('Evaluation ====>detectionAp is {} recognitionAp is {} avgTime {}'.format(epoch , detectionAp, recognitionAp,avgTime))
    # sys.exit(0)
    ...
    for epoch in range(epoch_start, num_epochs):
        ...
        if(detectionAp>best_detectionAp):
            ...
            torch.save(model.state_dict(), storeName +'stn-best-model')
